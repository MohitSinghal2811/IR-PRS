...
class ReleasedTrainForm(forms.Form):
    ...
    departureDate = forms.DateField(label = "Departure Date", help_text = "Departure Date should be atleast 60 days and atmost 180 days away", validators = [isDepartureDateValid, ])
